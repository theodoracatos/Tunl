...
`gen-v11-achievement-icons.py`). **The other 18 have no generator** - the 7 `ship_*`,
`first_flight`, `ace_pilot`, `master_fleet`, `ghost_hunter`, `new_legend`, `on_fire`,
`score_1000/10000/100000`, `streak_7/30`. They were uploaded to App Store Connect without
ever being committed, and were recovered from Apple's CDN on 2026-09-14. If one of these
ever needs a variant, it has to be redrawn or a generator written for it.
