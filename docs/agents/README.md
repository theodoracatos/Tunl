...
are about to change. Every section came from CLAUDE.md on 2026-09-21 with its heading unchanged, so an old
`CLAUDE.md "<Section>"` reference means that heading here. The same day the files were
condensed to rules; removed paragraphs are archived verbatim at the end of
...
| `hazards.md` | crystal stalactites, falling stalactites, boulders, cannons, mines |
| `portal.md` | warp portal: ring cadence, what a live warp does, placement |
| `coins.md` | gap bonus, chicane gold, power-up supply, coin types and rendering, poison/bomb/drain, blue-coin Zeitblase |
...
| `screens.md` | milestones, combo, death freeze, records, world rank, death screen, ghost |
| `share.md` | daily run card: content, two cuts, footer/QR, share gate, link |
